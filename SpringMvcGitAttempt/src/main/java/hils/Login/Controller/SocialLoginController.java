...
public class SocialLoginController {
	...
	// 네이버 로그인 첫 화면 요청 메소드
	@RequestMapping(value = "/login/SocialLogin", method = { RequestMethod.GET, RequestMethod.POST })
	...
	@RequestMapping(value = "/login/NmainPass", method = { RequestMethod.GET, RequestMethod.POST })
...
//==============================================================================
	...
	public void email2(HttpServletRequest request, String user_email, Model m) {

...
public class SetProfileDao {
	...
	public ProfileDto workoutInfo1_2(String workout_key){
		return session.selectOne("usersetting.workoutInfo1_2", workout_key);
	}
	...
	public List<String> early6key(int last){
		return session.selectList("usersetting.early6key", last);
	}

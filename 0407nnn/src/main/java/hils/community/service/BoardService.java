...
public class BoardService {
	...
	public void deleteArticleService(int b_number) {
		boardDao.deleteArticle(b_number);
	}
	public List<BoardDto> selectSpecificCategoryPreservedService(int start_number, int end_number, String b_category){
		Map<String, Object> paraMap = new HashMap<String, Object>();
		paraMap.put("b_category", b_category);
		paraMap.put("start_writing_num", start_number);
		paraMap.put("end_writing_num", end_number);
		
		return boardDao.selectSpecificCategoryPreserved(paraMap);
	}
	public int countCategoryService(String b_category) {
		return boardDao.countCategory(b_category); 
	}
	// subBoard
	public void deleteSubCommentService(int b_number) {
		boardDao.deleteSubComment(b_number);
	}

...
public class BoardDao {
	...
	public void deleteArticle(int b_number) {
		sqlSession.delete("board.deleteBoard", b_number);
	}
	public List<BoardDto> selectSpecificCategoryPreserved(Map<String, Object> paraMap){
		return sqlSession.selectList("board.selectBoardCategoryPreserved", paraMap);
	}
	public int countCategory(String b_category) {
		return sqlSession.selectOne("board.countCategory", b_category);
	}
	//subBoard
	public void deleteSubComment(int b_number) {
		sqlSession.delete("board.deleteSub", b_number);
	}    

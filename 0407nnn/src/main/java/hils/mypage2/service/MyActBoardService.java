...
public class MyActBoardService {
	...
	public MyActBoardListModel myActBoardlist(int pageNum, int per, String category, String searchWord, String myActUserId) {
		int count = dao.count(myActUserId);
		if (count == 0) {
	...
	public int getPagingCategory(String category, String myActUserId) {
		HashMap <String, Object> paraMap = new HashMap<String, Object>();
		paraMap.put("category", category);
		paraMap.put("USER_ID", myActUserId);
		return dao.getPagingCategory(paraMap);
	}

	public List<MyActBoardDto> selectmyActBoardService(int start, int end, String category, String myActUserId) {
		HashMap <String, Object> paraMap = new HashMap<String, Object>();
		paraMap.put("category", category);
		paraMap.put("start_writing_num", start);
		paraMap.put("end_writing_num", end);
		paraMap.put("USER_ID", myActUserId);
		return dao.selectMyActBoardList(paraMap);
	}

	public int myActBoardCategoryCount(String category, String myActUserId) {
		HashMap <String, Object> paraMap = new HashMap<String, Object>();
		paraMap.put("category", category);
		paraMap.put("USER_ID", myActUserId);
		return dao.myActBoardCategoryCount(paraMap); 
	}

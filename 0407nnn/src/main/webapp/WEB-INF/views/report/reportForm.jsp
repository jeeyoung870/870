...
<%
	...
	String r_board_num = request.getParameter("r_board_num");
%>
<html>
<head>
<!-- 합쳐지고 최소화된 최신 CSS -->
	...
	<div id="report">
		...
		<section id="container">
			<form action=reportWrite method="POST" class="form">
				...
				<fieldset disabled>
					<label class="control-label">신고대상</label><br/> 
					 <input type="text" id="disabledTextInput" class="form-control" placeholder="<%= reported_id %>" >
				</fieldset><br>
				...
				<input type="hidden" name="reporter_user" value="<%=reporter_id%>"><a></a>
				<input type="hidden" name="r_board_num" value="<%=r_board_num%>"><a></a>
				<div class="button">

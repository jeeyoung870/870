...
<style type="text/css">
	...
	.frmbtn{ width:90px; height:35px; color:white; background-color:#0383D8;
		border:0;outline:0; }
	#subsubbtn{width:fit-content; margin:0 auto;}
</style>
</head>
<body>
<div id="upper">
...
<fieldset>
	<br>
	상호(법인명)<br>
	<input class="textbox" type="text" name="company_name" value=${comp.company_name }><br>
	대표자명<br>
	<input class="textbox" type="text" name="representative_name" value=${comp.representative_name }><br>
	사업자 등록 번호<br>
	...
	대표 전화<br>
	<input class="textbox" type="text" name="phone_number" value=${comp.phone_number }><br>
	팩스<br>

...
<br/>
	...
	<div class = "content main">
		...
		<div class = "content line2">
			...
			<fmt:formatDate value="${specificContent.b_reg_date }" var = "main_date" pattern = "yyyy-MM-dd"/>
			<span class = "line3 elem2">${main_date }</span>
		</div>
	...
	<div class = "singleComment">
		...
		<div class = "line1 div">
			...
			<fmt:formatDate pattern = "yyyy-MM-dd" value = "${subArticle.c_reg_date }" var = "c_date"/>
			<span class = "line1 elem4">${c_date}</span>
		</div>
		<br/>
		<div class = "line2 div">
		...
		<script type="text/javascript">
		  		...
		  		function popupOpen() {
					...
					if (reported_id == reporter_id){
						...
						var popUrl = "${contextPath}/report/reportWrite?id=${specificContent.user_id}&r_board_num=${specificContent.b_number}"
							var popOption = "width=400, height=490, top=150, left=550, resizable=no, scrollbars=yes, status=no";

...
<style type="text/css">
	...
	#phnchange{ line-height:35px; width:fit-content; margin:0 auto; }
	...
	.frmbtn{ width:90px; height:35px; color:white; background-color:#FF3600;
		border:0;outline:0; border-radius: 1em;}
</style>
</head>
<body>
<div id="upper">
...
<div id="phnchange">
<br>현재 연락처<br>
<div id="oldphone" style="color:#FF3600">${user.user_phone}</div> <br>
<form action="phonechanged" method="post" onsubmit="return checkPhone()">
변경 연락처 <br>
<input type="text" name="newphone" id="newphone" class="textbox"/>
<input type="hidden" id="user_id" name="user_id" value="${user.user_id}" />
<br><br><input type="submit" value="변경하기" class="frmbtn" 

...
<body><!-- 커스텀 폼태그 사용가능 -->
	<div class = "inner">
	<form:form onsubmit = "return handleExceededChars()" enctype = "multipart/form-data" method = "post" action = "./doWrite" modelAttribute = "writeArticleModel" id = "writeArticleForm">
		<label for = "b_subject">enter your subject</label>
		<form:input type = "text" path = "b_subject" id = "b_subject" maxlength="75"></form:input>

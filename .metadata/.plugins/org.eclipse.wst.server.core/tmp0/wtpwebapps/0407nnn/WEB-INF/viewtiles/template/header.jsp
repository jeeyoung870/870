...
<script type="text/javascript">
	...
	socket.onerrors = function(event){
	...
	<header>
		...
		<div class="notification">
			<img
				...
				<form action = "goToNotiPage" method = "POST" id = "notificationResultForm">
				</form>
			<span id = "notiNumber" style = "color:white;"></span>
		</div>
	</header>
	<div class="menu">
		<!-- <span><a href="#" class="if1">회원가입 / 로그인</a></span> -->
			...
			if (!(id) && !(email)) {
				document
						.write('<a href="${contextPath}/user/register" style="color: black">회원가입</a>'
								+ '<a href="${contextPath}/user/SocialLogin" style="color: red">소셜 로그인</a>' 
				...
				.write('<img id="profile" src="' + sessionStorage.userImg + '">&nbsp;&nbsp;'
						...
						+ ' 회원님 환영합니다!'
						+ '<a href="${contextPath}/user/socialLogoutsuccess" style="color: red">로그아웃</a>')
				}
			}
		</script>
		</span>
		<ul>
			...
			<li><a href="#" class="iframe">커뮤니티</a>
				<ul class="sub">
					...
					<li><a href="${contextPath }/manageCustomerService/userAnnouBoard">공지사항 </a> <!-- <li><a href="#">test</a></li> -->
				</ul></li>
			<li><a href="timeline" class="iframe">타임라인</a></li>

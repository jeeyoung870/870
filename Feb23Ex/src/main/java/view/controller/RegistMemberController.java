...
import view.model.Code;
import view.model.MemberInfo;
import view.validator.MemberInfoValidator;

@Controller
@RequestMapping("/member/regist")
public class RegistMemberController {

	private String formViewName = "jsp/registMemberForm";
